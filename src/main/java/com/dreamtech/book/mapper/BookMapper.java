...
public interface BookMapper {
     ...
     * @return
     */
    @Select("SELECT a.*,b.name,(SELECT b.stu_num-COALESCE(SUM(c.stu_num),0) from book_info as c where c.status=1 and c.lab_id = b.id) as remainStuNum FROM book_info as a,lab_info as b where b.id = a.lab_id ")
